import java.util.*;
public class Pemrograman07Nomor1 {
    ...
    public static void addFilm(HashMap<String, ArrayList<String>> movieFavourite, Scanner vina2){
        vina2.nextLine();
        String judul;   String rilis;   String durasi;
        String genre;   String sinopsis;    String cast;

        System.out.println("Judul:"); judul = vina2.nextLine();
        System.out.println("Rilis:"); rilis = vina2.nextLine(); 
        System.out.println("Durasi:"); durasi = vina2.nextLine();
        System.out.println("Genre:"); genre = vina2.nextLine();
        System.out.println("Sinopsis:"); sinopsis = vina2.nextLine();
        System.out.println("Cast:"); cast = vina2.nextLine();
